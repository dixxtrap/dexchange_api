...
import { IsNumberString, IsOptional, IsPhoneNumber, ValidationOptions } from 'class-validator';
...
export const IsValidPhoneApi = (option?: Option) => {
  return applyDecorators(
    ...
    ApiProperty({ ...option?.apiPropertyOptions, type: String, example: '+1234567890' } as ApiPropertyOptions),
  );
};
